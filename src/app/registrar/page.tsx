                ...
                <div className={styles.modalOverlay}>
                    <div className={styles.modalContent}>
                        ...
                        <form onSubmit={handleSubmitNewModule}>
                            ...
                            <div className={styles.formGroup}>
                                <label htmlFor="moduleBeneficiary">受益人:</label>
                                <input
                                    type="text"
                            ...
                            <div className={styles.formGroup}>
                                <label htmlFor="unlockTime">解锁时间:</label>
                                <input
                                    type="date"
                                    id="unlockTime"
                                    value={new Date(unlockTime).toISOString().split('T')[0]}
                                    onChange={(e) => setUnlockTime(new Date(e.target.value).getTime())}
                                    required
                                />
                            </div>
